...
public class BTreeIndex implements Index {
	...
	private MetadataMgr md = SimpleDB.mdMgr();
	private TableInfo dirTi, leafTi;
	public TableInfo getLeafTi() {
		return leafTi;
	}
	...
	public BTreeIndex(String idxname, Schema leafsch, Transaction tx) {
		...
		md.createTable(leaftbl, leafsch, tx);
		//leafTi = new TableInfo(leaftbl, leafsch);
		leafTi = md.getTableInfo(leaftbl, tx);
		for (String alan : leafTi.schema().fields())
			System.out.println("leaf alanlar:" + alan);
	...
	public void beforeFirst(Constant searchkey) {
		...
		//System.out.println("atanan blok no:" + blknum);
		root.close();
...
//		if(leaf!=null)
//			System.out.println("leaf null deðill");
	...
	public void insert(Constant dataval, RID datarid) {
		beforeFirst(dataval);
//		if(leaf != null)
//			System.out.println("leaf null deðil");
//		else
//			System.out.println("leaf null");
//		if(datarid != null)
//			System.out.println("datarid null deðil");
//		else
//			System.out.println("datarid null");
